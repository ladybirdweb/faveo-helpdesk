...
class DatabaseSeeder extends Seeder {
	...
	public function run() {
		...
		foreach ($mailbox as $name => $value) {
			MailboxProtocol::create(array('name' => $name, 'value' => $value));
		}
		...
		help_topic::create(array('topic' => 'Sales query', 'department' => '2', 'ticket_status' => '1', 'priority' => '2', 'sla_plan' => '1', 'ticket_num_format' => '1', 'status' => '1', 'type' => '1', 'auto_response' => '0'));
		help_topic::create(array('topic' => 'Operational query', 'department' => '3', 'ticket_status' => '1', 'priority' => '2', 'sla_plan' => '1', 'ticket_num_format' => '1', 'status' => '1', 'type' => '1', 'auto_response' => '0'));
