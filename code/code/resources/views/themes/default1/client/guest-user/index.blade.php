...
<link href="{{asset("plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css")}}" rel="stylesheet" type="text/css" />
           <link href="{{asset("dist/css/widgetbox.css")}}" rel="stylesheet" type="text/css" />
...
<div id="corewidgetbox">
    ...
    @else
        ...
        <span onclick="javascript: window.location.href='{{url('auth/login')}}';">
            <a href="{{url('auth/login')}}" class="widgetrowitem defaultwidget" style="background-image: URL('https://support.ebs.in/app/__swift/themes/client/images/icon_widget_register.png');">
                <span class="widgetitemtitle">Sign In</span>
            </a>
        </span>
    @endif
    @if(App\Model\Settings\System::first()->status == 1)
