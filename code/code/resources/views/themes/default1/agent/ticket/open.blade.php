...
<div class="box box-primary">
     <div class="box-header with-border">
        <h3 class="box-title">Open </h3> <small>5 new messages</small>
        <div class="box-tools pull-right">
        <div class="has-feedback">
               {!! Form::open(array('url' => 'tickets/search/','method' => 'POST')) !!}
{!! Form::text('auto', $value = null, array('placeholder' => 'Search here', 'id' => 'auto', 'class' => 'form-control input-sm')) !!}
        ...
        <!-- table -->
            <table class="table table-hover table-striped">
                ...
                <tbody id="hello">
                    ...
                    {
                        $tickets = App\Model\Ticket\Tickets::where('status', '=', 1)->where('dept_id','=',Auth::user()->primary_dpt)->orderBy('id', 'DESC')->paginate(20);
                    } else {
                        $tickets = App\Model\Ticket\Tickets::where('status', '=', 1)->orderBy('id', 'DESC')->paginate(20);
                    }
                    ?>
