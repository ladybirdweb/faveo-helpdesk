...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">My Ticket </h3> <small></small>
            ...
            <table class="table table-hover table-striped">
                ...
                <tbody id="hello">
                    ...
                    if(Auth::user()->role == 'agent') {
                        $tickets = App\Model\Ticket\Tickets::where('status', '=', 1)->where('dept_id','=',Auth::user()->primary_dpt)->where('assigned_to', '=', Auth::user()->id)->orderBy('id', 'ASC')->paginate(20);
                    } else {
                        $tickets = App\Model\Ticket\Tickets::where('status', '=', 1)->where('assigned_to', '=', Auth::user()->id)->orderBy('id', 'ASC')->paginate(20);
                    }
                    ?>
