...
<div class="box box-primary">
    ...
    {!! Form::open(['route'=>'select_all','method'=>'post']) !!}
        <div class="mailbox-controls">
            ...
            <input type="submit" class="btn btn-default btn-sm" name="submit" value="Delete">
            <input type="submit" class="btn btn-default btn-sm" name="submit" value="Close">
...
?> >
                        <td><input type="checkbox" name="select_all[]" value="{{$ticket->id}}"/></td>
                        ...
                        <td class="mailbox-name"><a href="{!! route('ticket.thread',[$ticket->id]) !!}" title="{!! $title->title !!}">{{$string}}   </a> ({!! $count!!}) <i class="fa fa-comment"></i></td>
