    ...
    <div class="box-body">
        <div class="mailbox-controls">
            ...
            <div class="pull-right">
                <?php
$counted = count(App\Model\Ticket\Tickets::where('status', '=', 1)->where('user_id', '=' , Auth::user()->id)->get());
if ($counted < 20) {
        ...
        <!-- table -->
            <table class="table table-hover table-striped">
               ...
               <th></th>
                ...
                <tbody id="hello">
                    <?php $tickets = App\Model\Ticket\Tickets::where('status', '=', 1)->where('user_id', '=' , Auth::user()->id)->orderBy('id', 'DESC')->paginate(20);?>
