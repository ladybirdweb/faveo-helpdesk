...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Answered </h3> <small> 5 new messages</small>
    ...
    {!! Form::open(['route'=>'select_all','method'=>'post']) !!}
        <div class="mailbox-controls">
            ...
            <input type="submit" class="btn btn-default btn-sm text-orange" name="submit" value="Delete">
            <input type="submit" class="btn btn-default btn-sm text-yellow" name="submit" value="Close">
        ...
        <!-- table -->
            <table class="table table-hover table-striped">
                ...
                <tbody id="hello">
                    ...
                    $tickets = App\Model\Ticket\Tickets::where('status', '=', 1)->where('dept_id','=',Auth::user()->primary_dpt)->where('isanswered', '=', 1)->orderBy('id', 'DESC')->paginate(20);
                    } else {
                        $tickets = App\Model\Ticket\Tickets::where('status', '=', 1)->where('isanswered', '=', 1)->orderBy('id', 'DESC')->paginate(20);
                    }
                    ?>
