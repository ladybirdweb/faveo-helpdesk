...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Overdue </h3> <small> 5 new messages</small>
            ...
            <table class="table table-hover table-striped">
                ...
                <tbody id="hello">
                    ...
                    if(Auth::user()->role == 'agent') {
                        $tickets = App\Model\Ticket\Tickets::where('status', '=', 1)->where('dept_id','=',Auth::user()->primary_dpt)->where('isoverdue', '=', 1)->orderBy('id', 'DESC')->paginate(20);
                    } else {
                        $tickets = App\Model\Ticket\Tickets::where('status', '=', 1)->where('isoverdue', '=', 1)->orderBy('id', 'DESC')->paginate(20);
                    }
                    ?>
