            ...
            <table class="table table-hover table-striped">
                ...
                <tbody id="hello">
                    ...
                    if(Auth::user()->role == 'agent') {
                        $tickets = App\Model\Ticket\Tickets::where('assigned_to', '=', 0)->where('dept_id','=',Auth::user()->primary_dpt)->where('status','1')->orderBy('id', 'DESC')->paginate(20);
                    } else {
                        $tickets = App\Model\Ticket\Tickets::where('assigned_to', '=', 0)->where('status','1')->orderBy('id', 'DESC')->paginate(20);
                    }
