...
<?php 
    ...
    $group = App\Model\Agent\Groups::where('name', '=', $agent_group)->where('group_status', '=', '1')->first();
?>
...
?>
                ...
                <div class="col-md-6">
                    <table class="table table-hover"id="refresh">
                        <tr><td><b>Status:</b></td>       <?php $status = App\Model\Ticket\Ticket_Status::where('id', '=', $tickets->status)->first();?><td title="{{$status->properties}}">{{$status->name}}</td></tr>
                    ...
                    <div id="t1">
                            ...
                            <!-- to -->
                                ...
                                <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#addccc"> Add Ccc </a>
                                        <div id="recepients">
                                        <?php $Collaborator =  App\Model\Ticket\Ticket_Collaborator::where('ticket_id', '=', $tickets->id)->get(); 
                        ...
                        <div class="form-group">
                            ...
                            <!-- responnse -->
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" style="width:55%" name="CannedResponse" onChange="update('name')">
                                        <option value="Select a canned response">Select a canned response</option>
                                        <option value="Original Message">Original Message</option>
                        ...
                        <div class="form-group">
                            ...
                            <!-- reply content -->
                                <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-10">
                                        <textarea style="width:98%;height:200px;" name="ReplyContent" class="form-control" id="ReplyContent"></textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php $sla_plans = App\Model\Manage\Sla_plan::all() ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php $help_topics = App\Model\Manage\Help_topic::all() ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php $ticket_sources = App\Model\Ticket\Ticket_source::all() ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php $ticket_prioritys = App\Model\Ticket\Ticket_Priority::all() ?>
...
$teams = App\Model\Agent\Teams::all();
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="ahah">
                            <div class="modal-body" id="def">
                                <div class="callout callout-info"><i class="icon fa fa-info"> </i>&nbsp;&nbsp;&nbsp; Search existing users or add new users</div>
                                <div id="here"></div>
