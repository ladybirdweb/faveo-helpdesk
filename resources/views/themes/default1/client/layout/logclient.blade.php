            ...
            <header id="masthead" class="site-header" role="banner">
                ...
                <div class="container">
                    ...
                    <div id="header-search" class="site-search clearfix" style="margin-right: 20%; width: 100%"><!-- #header-search -->
                        ...
                        <div class= "form-border" style=" margin-right: 20%;width: 80%;">
                            <div class="form-inline ">
                                <div class="form-group input-group" style="width: 95%">
                                    ...
                                    <span class="input-group-btn">
                                        <button type="submit" class="btn btn-custom btn-md " style="margin-left: 25% ;border-color: rgb(0, 192, 239);background-color: #009aba; hov: #00c0ef; color: #fff">Search</button>
                                    </span>
                                \</div>
                        {!! Form::close() !!}
                    </div>
