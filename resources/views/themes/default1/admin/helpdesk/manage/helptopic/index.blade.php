...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <a href="{{route('helptopic.create')}}" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus"></span> &nbsp;{{trans('lang.create_help_topic')}}</a>
    </div>
        ...
        <table class="table table-bordered dataTable">
            ...
            <tr style="padding-bottom:-30px">
                ...
                <td>
                    ...
                    <a href="{{route('helptopic.edit',$topic->id)}}" class="btn btn-info btn-xs btn-flat"><i class="fa fa-trash" style="color:black;"> </i> {!! trans('lang.edit') !!}</a>
