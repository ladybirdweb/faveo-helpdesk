            ...
            <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody class="inputField">
                    ...
                    <tr>
                        ...
                        <td>{!! trans("lang.yes") !!}&nbsp;&nbsp;<input type=radio name="required[0]" value=1 checked>&nbsp;&nbsp;{!! trans("lang.no") !!}&nbsp;&nbsp;<input type=radio name="required[0]" value=0></td>
