...
<form id="form">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{!! trans('lang.email_information_and_settings') !!}</h3>
        </div>
        <div class="box-body">
            <div id="head"></div>
        ...
        <div class="box-header with-border">
            <h3 class="box-title">{!! trans('lang.new_ticket_settings') !!}</h3>
        </div>
        <div class="box-body">
            <div class="row">
                <!-- department -->
        ...
        <div class="box-header with-border">
            <h3 class="box-title">{!! trans('lang.incoming_email_information') !!}</h3>
        </div>
        <div class="box-body">
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-xs-2 form-group">
                        <!--{!! Form::radio('fetching_status','1',true) !!} {{trans('lang.enable')}}-->
                        <input type="checkbox" name="fetching_status" id="fetching_status"> {{trans('lang.enable')}}
                    </div>
                    <div class="col-xs-2 form-group">
                        <!--<input type="radio" name="fetching_status" id="fetching_status" value="0"> {{trans('lang.disabled')}}-->
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="box-header with-border">
            <h3 class="box-title">{!! trans('lang.outgoing_email_information') !!}</h3>
        </div>
        <div class="box-body">
            <div class="row">
                <!-- status -->
                <div class="form-group">
                    ...
                    <div class="col-xs-2 form-group"> 
                        <!--<input type="radio" name="sending_status" id="sending_status" value=""> {!! trans('lang.disabled') !!}-->
                    </div> 
                </div>
            </div>
            <div class="row">
        ...
        <div class="box-footer">
            {!! Form::button('<i id="spin" class="fa fa-spinner" style="display:none;"></i> <b>' . trans("lang.create").'</b>' ,['class'=>'btn btn-primary', 'type' => 'submit'])!!}
        </div>
    </div>
</form>
