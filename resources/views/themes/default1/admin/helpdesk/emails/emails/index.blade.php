...
<div class="box-header">
	<h2 class="box-title">{!! trans('lang.emails') !!}</h2><a href="{{route('emails.create')}}" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus"></span> &nbsp;{{trans('lang.create_email')}}</a></div>
