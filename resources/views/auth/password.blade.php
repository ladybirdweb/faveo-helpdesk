...
<form role="form" method="POST" action="{{ url('/password/email') }}">
    ...
    <div class="form-group has-feedback {{ $errors->has('email') ? 'has-error' : '' }}">
            {!! Form::label('password',trans('lang.enter_your_email_here')) !!}
    ...
    <div class="col-xs-4">
        <span class="input-group-btn"><button type="submit" class="btn btn-primary btn-block btn-flat">{!! trans('lang.send') !!}</button></span>
        <br/>
    </div>
    </div> 
       </div>
