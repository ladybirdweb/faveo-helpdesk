<ul class="list-unstyled">
    ...
    <li style="margin-left: -10px;">
        <a class="pointer" id="folder_root" data-id="/" onclick="clickRoot()">
            <i class="fa fa-folder-open" data-id="/"></i> {{ trans('laravel-filemanager::lfm.title-root') }}
        </a>
    </li>
    ...
    <a id="add-folder" class="add-folder btn btn-default btn-xs" style='margin-top:15px;'>
        <i class="fa fa-plus"></i> {{ trans('laravel-filemanager::lfm.menu-new') }}
    </a>
    <hr>
    @endif
    <li style="margin-left: -10px;">
        <a class="pointer" id="folder_shared" data-id="/" onclick="clickShared()">
            <i class="fa fa-folder" data-id="/"></i> {{ trans('laravel-filemanager::lfm.title-shares') }}
        </a>
    </li>
