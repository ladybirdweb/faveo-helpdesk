...
return [
    ...
    /*
      ...
      |--------------------------------------
     */
    'template-types'                => 'lllll',
    'modify'                        => 'lllll',
    'rating_name'                   => 'lllll',
    'add_user_to_this_organization' => 'lllll',
    'Tickets_of'                    => 'lllll',
    'security'                      => 'lllll',
    'manage_status'                 => 'lllll',
    'Login_to_start_your_session'   => 'lllll',
    'login'                         => 'lllll',
    'remember'                      => 'lllll',
    'signmein'                      => 'lllll',
    'iforgot'                       => 'lllll',
    ...
    'password'                      => 'lllll',
    'woops'                         => 'lllll',
    'theirisproblem'                => 'lllll',
    'login'                         => 'lllll',
    'e-mail'                        => 'E-lllll',
    'reg_new_member'                => 'lllll',
    /*
      |--------------------------------------
      |   Register Page
      |--------------------------------------
    ...
    'firstname'                   => 'lllll',
    'lastname'                    => 'lllll',
    'profilepicture'              => 'lllll',
    'oldpassword'                 => 'lllll',
    'newpassword'                 => 'lllll',
    'retype_password'             => 'lllll',
    'i_agree_to_the'              => 'lllll',
    'terms'                       => 'lllll',
    'register'                    => 'lllll',
    'i_already_have_a_membership' => 'lllll',
    'see-profile1'                => 'lllll',
    'see-profile2'                => 'lllll',
    /*
      |--------------------------------------
      ...
      |--------------------------------------
     */
    'reset_password' => 'lllll',
    /*
      |--------------------------------------
      |   Forgot Password Page
      |--------------------------------------
     */
    'i_know_my_password'            => 'lllll',
    'recover_passord'               => 'lllll',
    'send_password_reset_link'      => 'lllll',
    'enter_email_to_reset_password' => 'lllll',
    'link'                          => 'lllll',
    /*
      |----------------------------------------------------------------------------------------
     ...
     */
    'emails'                         => 'lllll',
    'incoming_emails'                => 'lllll',
    'reuired_authentication'         => 'lllll',
    'fetching_email_via_imap'        => 'lllll',
    'create_email'                   => 'lllll',
    'email_address'                  => 'lllll',
    'email_name'                     => 'lllll',
    'help_topic'                     => 'lllll',
    ...
    'host_name'                      => 'lllll',
    'port_number'                    => 'lllll',
    'mail_box_protocol'              => 'lllll',
    'authentication_required'        => 'lllll',
    'yes'                            => 'lllll',
    'no'                             => 'lllll',
    'header_spoofing'                => 'lllll',
    'allow_for_this_email'           => 'lllll',
    'imap_config'                    => 'lllll',
    'email_information_and_settings' => 'lllll',
    'incoming_email_information'     => 'lllll',
    'outgoing_email_information'     => 'lllll',
    'new_ticket_settings'            => 'lllll',
    'protocol'                       => 'lllll',
    'fetching_protocol'              => 'lllll',
    'transfer_protocol'              => 'lllll',
    'from_name'                      => 'lllll',
    'add_an_email'                   => 'lllll',
    'edit_an_email'                  => 'lllll',
    'disable_for_this_email_address' => 'lllll',
    /*
      |--------------------------------------
    ...
    'templates'       => 'lllll',
    'template_set'    => 'lllll',
    'create_template' => 'lllll',
    'edit_template'   => 'lllll',
    'in_use'          => 'lllll',
    //Template Description
    'Create ticket agent'       => 'lllll',
    'Assign ticket'             => 'lllll',
    'Create ticket'             => 'lllll',
    'Check ticket'              => 'lllll',
    'Ticket reply agent'        => 'lllll',
    'Registration notification' => 'lllll',
    'Reset password'            => 'lllll',
    'Error report'              => 'lllll',
    'Ticket creation'           => 'lllll',
    'Ticket reply'              => 'lllll',
    'Close ticket'              => 'lllll',
    'Create ticket by agent'    => 'lllll',
    /*
      |--------------------------------------
      |  Templates Create Page
      |--------------------------------------
     */
    'template_set_to_clone' => 'lllll',
    'language'              => 'lllll',
    /*
      |--------------------------------------
      |  Diagnostics Page
    ...
    'api'                   => 'lllll',
    'api_key'               => 'lllll',
    'api_key_mandatory'     => 'lllll',
    'api_configurations'    => 'lllll',
    ...
    'first_name'                               => 'llllll',
    'last_name'                                => 'llllll',
    'mobile_number'                            => 'llllll',
    'agent_signature'                          => 'llllll',
    'account_status_setting'                   => 'llllll',
    'account_type'                             => 'llllll',
    'admin'                                    => 'llllll',
    'agent'                                    => 'llllll',
    'account_status'                           => 'llllll',
    'locked'                                   => 'llllll',
    'assigned_group'                           => 'llllll',
    'primary_department'                       => 'llllll',
    'agent_time_zone'                          => 'llllll',
    'day_light_saving'                         => 'llllll',
    'limit_access'                             => 'llllll',
    'directory_listing'                        => 'llllll',
    'vocation_mode'                            => 'llllll',
    'assigned_team'                            => 'llllll',
    'agent_send_mail_error_on_agent_creation'  => 'llllll',
    'agent_creation_success'                   => 'llllll',
    'failed_to_create_agent'                   => 'llllll',
    'failed_to_edit_agent'                     => 'llllll',
    'agent_updated_sucessfully'                => 'llllll',
    'unable_to_update_agent'                   => 'llllll',
    'agent_deleted_sucessfully'                => 'llllll',
    'this_staff_is_related_to_some_tickets'    => 'llllll',
    'list_of_agents'                           => 'llllll',
    'create_an_agent'                          => 'llllll',
    'edit_an_agent'                            => 'llllll',
    ...
    /*
      ...
      |--------------------------------------
     */
    'create_department'                                => 'llllll',
    'manager'                                          => 'llllll',
    'ticket_assignment'                                => 'llllll',
    'restrict_ticket_assignment_to_department_members' => 'llllll',
    'outgoing_emails'                                  => 'llllll',
    'outgoing_email'                                   => 'llllll',
    'template_set'                                     => 'llllll',
    'auto_responding_settings'                         => 'llllll',
    'disable_for_this_department'                      => 'llllll',
    'auto_response_email'                              => 'llllll',
    'recipient'                                        => 'llllll',
    'group_access'                                     => 'llllll',
    'department_signature'                             => 'llllll',
    'list_of_departments'                              => 'llllll',
    'create_a_department'                              => 'llllll',
    'outgoing_email_settings'                          => 'llllll',
    'edit_department'                                  => 'llllll',
    'select_a_sla'                                     => 'llllll',
    'select_a_manager'                                 => 'llllll',
    'department_created_sucessfully'                   => 'llllll',
    'failed_to_create_department'                      => 'llllll',
    'department_updated_sucessfully'                   => 'llllll',
    'department_not_updated'                           => 'llllll',
    'you_cannot_delete_default_department'             => 'llllll',
    'have_been_moved_to_default_department'            => 'llllll',
    'the_associated_helptopic_has_been_deactivated'    => 'llllll',
    'department_deleted_sucessfully'                   => 'llllll',
    'department_can_not_delete'                        => 'llllll',
    'select_a_department'                              => 'llllll',
    /*
      |--------------------------------------
      |  Team Create Page
      |--------------------------------------
    ...
    'create_team'                      => 'llllll',
    'team_lead'                        => 'llllll',
    'assignment_alert'                 => 'llllll',
    'disable_for_this_team'            => 'llllll',
    'teams'                            => 'llllll',
    'list_of_teams'                    => 'llllll',
    'create_a_team'                    => 'llllll',
    'edit_a_team'                      => 'llllll',
    'teams_created_successfully'       => 'llllll',
    'teams_can_not_create'             => 'llllll',
    'teams_updated_successfully'       => 'llllll',
    'teams_can_not_update'             => 'llllll',
    'teams_deleted_successfully'       => 'llllll',
    'teams_can_not_delete'             => 'llllll',
    'select_a_team'                    => 'llllll',
    'select_a_team_lead'               => 'llllll',
    'members'                          => 'llllll',
    /*
      |--------------------------------------
      |  Group Create Page
    ...
    'create_group'          => 'llllll',
    'goups'                 => 'llllll',
    'can_create_ticket'     => 'llllll',
    'can_edit_ticket'       => 'llllll',
    'can_post_ticket'       => 'llllll',
    'can_close_ticket'      => 'llllll',
    'can_assign_ticket'     => 'llllll',
    'can_transfer_ticket'   => 'llllll',
    'can_delete_ticket'     => 'llllll',
    'can_ban_emails'        => 'llllll',
    'can_manage_premade'    => 'llllll',
    'can_manage_FAQ'        => 'llllll',
    'can_view_agent_stats'  => 'llllll',
    'department_access'     => 'llllll',
    'admin_notes'           => 'llllll',
    'group_members'         => 'llllll',
    'group_name'            => 'llllll',
    'select_a_group'        => 'llllll',
