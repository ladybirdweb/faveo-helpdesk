...
return [
    ...
    'accepted'   => '属性 :attribute 不被接受.',
    'active_url' => '属性 :attribute 不是一个有效的url.',
    'after'      => '属性 :attribute 必须是一个日期.',
    'alpha'      => '属性 :attribute 只能包含字母.',
    'alpha_dash' => '属性 :attribute 只能包含数字、字母、下划线.',
    'alpha_num'  => '属性 :attribute 只能包含数字、字母.',
    'array'      => '属性 :attribute 必须是个数组.',
    'before'     => '属性 :attribute 必须是个日期.',
    'between'    => [
        'numeric' => '属性 :attribute 必须在最小数与最大数之间.',
        'file'    => '属性 :attribute 必须在最小与最大之间千字节.',
        'string'  => '属性 :attribute 必须在最小与最大字符之间.',
        'array'   => '属性 :attribute 必须在最小与最大之间.',
    ],
    'boolean'        => '属性 :attribute 必须为true或者false.',
    'confirmed'      => '属性 :attribute 不匹配.',
    ...
    'exists'         => '属性 选择:attribute 无效.',
    'image'          => '属性 :attribute 必须是图片.',
    'in'             => '属性 选择 :attribute 无效.',
