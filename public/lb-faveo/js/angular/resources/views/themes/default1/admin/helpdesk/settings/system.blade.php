        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <a href="#" data-toggle="tooltip" title="{!! Lang::get('lang.the_rtl_support_is_only_applicable_to_the_outgoing_mails') !!}"><i class="fa fa-question-circle" style="padding: 0px;"></i></a>
                    <div class="row">
                        <div class="col-xs-12">
                            <?php
        ...
        <div class="row">    
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <a href="#" data-toggle="tooltip" title="ITIL"><i class="fa fa-question-circle" style="padding: 0px;"></i></a>
                    <?php
                    $yes = false;
                    $no = false;
