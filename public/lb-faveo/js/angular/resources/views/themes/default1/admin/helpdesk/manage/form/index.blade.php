        ...
        <table id="example2" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                           <a href="{{url('forms/'. $form->id.'/edit')}}" class="btn btn-primary btn-xs"><i class="fa fa-edit" style="color:white;"> &nbsp;</i>&nbsp;{!!Lang::get('lang.edit')!!}</a>&nbsp;               
                        </div>
                        <div class="btn-group">
                           <a href="{{url('forms/'. $form->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-eye" style="color:white;">&nbsp; </i>&nbsp;{!!Lang::get('lang.view_this_form')!!}</a>&nbsp;               
                            
                           <!--{!! link_to_route('forms.show', Lang::get('lang.view_this_form') ,[$form->id],['id'=>'View','class'=>'btn btn-primary btn-sm']) !!}-->
                        </div>
                        <div class="btn-group">
                              <a href="{{url('forms/add-child/'. $form->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-plus" style="color:white;">&nbsp; </i>&nbsp;&nbsp;&nbsp;{!!Lang::get('lang.add_child')!!}</a>&nbsp;                  
                            <!--{!! link_to_route('forms.add.child', 'Add Child' ,[$form->id],['id'=>'add-child','class'=>'btn btn-primary btn-sm']) !!}-->
                        </div>
                        <div class="btn-group">
                            <button class="btn btn-primary btn-xs`" data-toggle="modal" data-target="#{{$form->id}}delete"><i class="fa fa-eye" style="color:white;">&nbsp; </i>&nbsp;{!! Lang::get('lang.delete_from') !!}</button>
                        </div>
