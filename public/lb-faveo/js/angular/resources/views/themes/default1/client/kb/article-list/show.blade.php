    ...
    <article class="hentry">
        <header class="entry-header">
            ...
            <div class="entry-meta text-muted">
                <span class="date"><i class="fa fa-film fa-fw"></i> <time datetime="2013-09-19T20:01:58+00:00">{{faveoDate($arti->created_at)}}</time></span>
                    ...
                    <footer class="comment-meta">
                        ...
                        <div class="comment-metadata">
                            <small class="date text-muted">
                                <time datetime="2013-10-23T01:50:50+00:00">{!! faveoDate($comment->created_at) !!}</time>
                            </small>
