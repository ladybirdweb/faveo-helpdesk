                        ...
                        <div class="col-md-3">
                            <div class="widget-area">
                                <section id="section-about" class="section">
                                    <h2 class="section-title h4 clearfix" style="word-wrap: break-word;">{!!$footer1->title!!}</h2>
                                    <div class="textwidget">
                                           <P style="word-wrap: break-word;"><?php  echo ($footer1->value);?></P>
                                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="widget-area">
                                <section id="section-latest-news" class="section">
                                    ...
                                    <div class="textwidget">
                                          <P style="word-wrap: break-word;"><?php  echo ($footer2->value);?></P>
                                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="widget-area">
                                <section id="section-newsletter" class="section">
                                    ...
                                    <div class="textwidget">
                                          <P style="word-wrap: break-word;"><?php  echo ($footer3->value);?></P>
                                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="widget-area">
                                <section id="section-newsletter" class="section">
                                    ...
                                    <div class="textwidget">
                                           <P style="word-wrap: break-word;"><?php  echo ($footer4->value);?></P>
                                    </div>
                                </section>
                            </div>
                        </div>
