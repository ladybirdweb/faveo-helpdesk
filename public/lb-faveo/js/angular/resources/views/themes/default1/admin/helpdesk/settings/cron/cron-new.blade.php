...
<!--        <div class="alert  alert-dismissable" style="background: #F3F3F3">
         ...
         <div class="alert  alert-dismissable" style="background: #F3F3F3">
            <i class="fa  fa-info-circle"></i>&nbsp;Please set this command in your cron
            {!! $shared !!}<br>
            <p>If your server doesn't support CLI, You can use direct <a href='#tab_2' data-toggle="tab" id="tab2url" style="color: red;">URL</a></p>
        </div>
        ...
        <div class="col-md-6">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('escalation_cron',Lang::get('lang.sla_escalation')) !!}<br>
                           {!! Form::checkbox('escalation_cron',1,$condition->checkActiveJob()['notification'],['id'=>'escalation_cron']) !!}&nbsp;{{Lang::get('lang.send_sla_escalation')}}
                        </div>
                    </div>
                    <div class="col-md-6" id="notification2">
                        {!! Form::select('escalation_commands',["everyThirtyMinutes" => "Every Thirty Minute"],'everyThirtyMinutes',['class'=>'form-control','id'=>'escalation-command']) !!}
                        <div id='notification-daily-at2'>
                            {!! Form::text('sla_escalation_dailyAt',$condition->getConditionValue('escalation')['at'],['class'=>'form-control']) !!}
                        </div>
                    </div>
                </div><!-- /.info-box-content -->
            </div><!-- /.info-box -->
        </div>
        <?php Event::fire('cron.settings.view',['commands'=>$commands,'condition'=>$condition]); ?>
