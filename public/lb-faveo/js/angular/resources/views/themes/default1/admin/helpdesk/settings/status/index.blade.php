        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{!! route('status.edit',$status->id) !!}"><button class="btn btn-primary btn-xs"> <i class='fa fa-edit'> &nbsp;</i> {!! Lang::get('lang.edit') !!}</button></a>&nbsp;&nbsp;
                        <button class="btn btn-primary btn-xs" <?php if($status->default == 1 || $status->id == 6) { echo "disabled='disabled'"; } ?> data-toggle="modal" data-target="#{{$status->id}}delete"> <i class='fa fa-trash'>&nbsp; </i> {!! Lang::get('lang.delete') !!}</button>
