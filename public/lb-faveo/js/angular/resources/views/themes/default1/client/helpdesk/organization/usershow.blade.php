...
<div class="row">
    ...
    <div class="col-md-9" style="margin-left:-10px;">
        ...
        <!-- Delete -->
        <form action="{!!URL::route('client.deleteuser', $users->id)!!}" method="post" role="form">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <br/>
                    <form name="myForm" action="{!!URL::route('clientpanel.user.post.changepassword', $users->id)!!}" method="post" role="form" onsubmit="return validateForm()">
    ...
    <!-- Restore -->
    <!-- Admin -->
    <form action="{!!URL::route('clientpanel.user.restore', $users->id)!!}" method="post" role="form">
    ...
    <script>
        ...
        $('#changepassword').click(function() {
            $.ajax({
                type: 'get',
                url: '{{route("clientpanel.user.changepassword")}}',
...
@if($users->is_delete != '1')
                            ...
                            <a href="{{route('client.organizations.edituser', $users->id)}}"><button type="button"  href="{{route('user.edit', $users->id)}}" class="btn btn-primary btn-sm">{{Lang::get('lang.edit')}}</button></a>
...
//close autocomplite
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            // {{route('clientpanel.user-agen', $users->id)}}
