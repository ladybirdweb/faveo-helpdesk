...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <button type="button" class="btn btn-primary pull-right" id="Edit_Ticket" data-toggle="modal" data-target="#Edit"><b><span class="glyphicon glyphicon-plus">&nbsp;</span>{!! Lang::get('lang.add_plugin') !!}</b></button>        
