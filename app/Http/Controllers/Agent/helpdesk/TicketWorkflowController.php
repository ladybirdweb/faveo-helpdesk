...
class TicketWorkflowController extends Controller {
    ...
    public function checkRuleCondition($to_check, $condition, $statement) {
        if($condition == 'equal') {
            ...
            $return = $this->endsWith($to_check, $statement);
        }
