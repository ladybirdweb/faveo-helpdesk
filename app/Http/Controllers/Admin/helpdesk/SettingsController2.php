...
//        }
    ...
    public function getsystem(System $system, Department $department, Timezones $timezone, Date_format $date, Date_time_format $date_time, Time_format $time)
    {
        try {
            ...
            return view('admin.helpdesk.settings.system', compact('systems', 'departments', 'timezones', 'time', 'date', 'date_time'));
        } catch (Exception $e) {
            return redirect()->back()->with('fails', $e->getMessage());
        }
    }
    ...
    public function getSchedular(Email $email, Template $template, Emails $email1)
    {
        ...
        return view('admin.helpdesk.settings.crone', compact('emails', 'templates', 'emails1'));
        // } catch {
    ...
    // 		return view('admin.helpdesk.settings.access', compact('accesses'));
    // 	} catch (Exception $e) {
    // 		return view('404');
    // 	}
    // }
