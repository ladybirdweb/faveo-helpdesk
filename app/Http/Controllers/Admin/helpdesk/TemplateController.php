...
//   }
    ...
    public function postDiagno(Request $request)
    {
        ...
        $mail = $this->PhpMailController->sendmail($from = $this->PhpMailController->mailfrom('1', '0'), $to = ['email' => $email], $message = ['subject' => 'Checking the connection', 'scenario' => 'assign_ticket', 'content' => 'Email Received Successfully'], $template_variables = ['system_error' => 'Email Received Successfully']);
